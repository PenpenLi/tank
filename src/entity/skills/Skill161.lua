...
function Skill.excute(sender)
    local monsterId = qy.DungeonUtil.appendNum(require("entity.skills.Skill161").getAddMonsterId(), qy.DungeonModel:getExploreData()["difficulty_level"])
    ...
    local buffConfig = require("entity.skills.Skill161").getBuffConfig()
    for i = 1, 3 do
...
function Skill.getBuffConfig()
    local skillConfig = qy.Config.skill["161"]
